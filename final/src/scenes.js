...
function start() {
    ...
    this.enter = () => {
        ...
        switches.mode.position(this.x + 70, this.y - 30);
    }
    this.setup = () => {
    ...
    this.draw = () => {
        ...
        if (mode == 'single') {
            ...
            textSize(20);
            fill('white');
            text("Single Player", this.x, this.y - 50);
            ...
            text("Q", this.x + 650, this.y - 375);
            text("E", this.x + 650, this.y - 335);
        ...
        if (mode == 'double') {
            ...
            textSize(20);
            fill('white');
            text("Multiplayer", this.x, this.y - 50);
            ...
            stroke(0);
            strokeWeight(2);
            fill(0, col.upSat, col.up);
            rect(this.x + 540, this.y - 400, 40, 40, 5);

            fill(0, col.leftSat, col.left);
            rect(this.x + 500, this.y - 360, 40, 40, 5);

            fill(0, col.downSat, col.down);
            rect(this.x + 540, this.y - 360, 40, 40, 5);

            fill(0, col.rightSat, col.right);
            rect(this.x + 580, this.y - 360, 40, 40, 5);
            ...
            fill(100);
            text("↑", this.x + 560, this.y - 373);
            text("←", this.x + 520, this.y - 335);
            text("↓", this.x + 560, this.y - 335);
            text("→", this.x + 600, this.y - 335);
            text("N", this.x + 650, this.y - 375);
            text("M", this.x + 650, this.y - 335);
            ...
            fill(0, col.qs, col.q);
            rect(this.x - 680, this.y - 400, 40, 40, 5);

            fill(0, col.es, col.e);
            rect(this.x - 680, this.y - 360, 40, 40, 5);

            fill(100);
            text("W", this.x - 560, this.y - 373);
            text("A", this.x - 600, this.y - 335);
            text("S", this.x - 560, this.y - 335);
            text("D", this.x - 520, this.y - 335);
            text("Q", this.x - 660, this.y - 375);
            text("E", this.x - 660, this.y - 335);
